...
### Added
- cc-update-changelog command for automated changelog generation and maintenance
- Support for creating pull requests directly from changelog updates
- .claude/commands directory structure for custom slash commands
