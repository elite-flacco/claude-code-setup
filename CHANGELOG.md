...
### Added
- Audio notification WAV files (`on-agent-complete.wav`, `on-agent-need-attention.wav`) for agent completion and attention events

### Changed
- Updated README file structure documentation to include audio notification files
