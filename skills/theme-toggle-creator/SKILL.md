...
Interpret user's intent to either implement the dropdown or non-dropdown version below.
...
Do this if user wants to implement it as a dropdown, otherwise use the single button option below.
